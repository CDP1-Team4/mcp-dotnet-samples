...
module mcpEntraApp './modules/mcp-entra-app.bicep' = {
  ...
  params: {
    ...
    appScopes: ['Files.ReadWrite.All', 'email', 'offline_access', 'openid', 'profile']
    appRoles: []
  }
}
...
module fncapp './modules/functionapp.bicep' = {
  ...
  params: {
    ...
    entraAppId: mcpEntraApp.outputs.mcpAppId
    entraAppIdUri: mcpEntraApp.outputs.mcpAppIdUri
    appSettings: {}
...
//   name: 'mcpOneDriveDownload-fetch-image'
//   params: {
...
output AZURE_RESOURCE_MCP_ID_URI string = mcpEntraApp.outputs.mcpAppIdUri
